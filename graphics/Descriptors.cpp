...
// *************** Descriptor Pool *********************
    ...
    DescriptorPool::DescriptorPool(
        ...
        if (vkCreateDescriptorPool(m_device.getVkDevice(), &descriptorPoolInfo, nullptr, &m_descriptorPool) !=
            VK_SUCCESS) {
...
// *************** Descriptor Writer *********************
    ...
    void DescriptorWriter::overwrite(VkDescriptorSet &set) {
        ...
        vkUpdateDescriptorSets(m_pool.m_device.getVkDevice(), m_writes.size(), m_writes.data(), 0, nullptr);
    }
} // moonshine